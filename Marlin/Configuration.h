...
#define STRING_CONFIG_H_AUTHOR "(Shivam Mehta)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HEVO 3D Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 397 }
